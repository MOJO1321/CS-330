...
namespace
{
    const char* const WINDOW_TITLE = "Assignment Module 2"; // Macro for window title
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] =
    {
        ...
        // index 1
        -1.0f, 0.0f, 0.0f,     // left-center of the screen
        0.0f, 0.0f, 1.0f, 1.0f, // blue

        // index 2
        -0.48f, 0.0f, 0.0f,      // top-first third of the screen
